...
class ConfigMgr:
    ...
    def init_skill_config(self):
        ...
        self.skill_words = [
            ...
            '单挑','一个打十个','挑衅','嘲讽','骂街','火攻','围三缺一',
            '木牛流马','挖地道','水攻','箭雨','诈降','诱敌深入',
            '成语大师','水淹七军','阵前倒戈','虚张声势',

            # 36计
            '金蝉脱壳', '抛砖引玉', '借刀杀人', '以逸待劳', '擒贼擒王', 
            '趁火打劫', '关门捉贼', '浑水摸鱼', '打草惊蛇', '瞒天过海', 
            '笑里藏刀', '顺手牵羊', '调虎离山', '李代桃僵', '借尸还魂',
            '指桑骂槐', '隔岸观火', '树上开花', '暗渡陈仓', '假道伐虢',
            '假痴不癫', '欲擒故纵', '釜底抽薪', '声东击西', '围魏救赵',
            '远交近攻', '反客为主', '上屋抽梯', '偷梁换柱', '无中生有',
            '反间计', '美人计', '苦肉计', '空城计',  '连环计',
            '走为上计',
        ]
...
'刘秀','王莽','蔡伦','耿弇','邓禹','吴汉','马援',
'单福',
'慕容垂','慕容翰','苻坚','谢安','谢玄','桓温','刘裕','刘牢之','陈霸先','陈庆之','王羲之',
'王猛','王镇恶','刘裕','李雄','拓跋圭','宇文护',
'杨素','韩擒虎','高颖',
'李靖','秦琼','尉迟恭','程咬金','杨林','魏文通',
'李元霸','宇文成都','裴元庆','李绩','李密','徐茂公','单雄信','罗士信','张烈',
'薛礼','薛仁贵','张士贵','侯君集','长孙无忌','苏定方','窦建德','王世仁',
'李白','杜甫','王维','杜牧','李商隐','白居易',
'朱温','朱全忠','安禄山','哥舒翰','李克用','李存孝',
'郭威','赵匡胤','柴荣','寇准',
'杨业','杨延昭','杨文广','孟良','焦赞','呼延灼','潘美','庞籍',
...
'李逍遥','燕赤霞','宁采臣','聂小倩',
'金庸','杨过','张无忌','黄药师','欧阳锋','洪七','段誉','乔峰','慕容复',
'沈浪','王怜花','李寻欢','白阿飞','荆无名','上官金虹',
