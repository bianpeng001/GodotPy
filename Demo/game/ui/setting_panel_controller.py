...
class SettingPanelController(UIController, PopupTrait):
    ...
    def setup(self, ui_obj):
        ...
        self.ui_obj.find_node('Panel/BtnClose').connect(PRESSED, on_close)
        self.ui_obj.find_node('Panel/BtnCancel').connect(PRESSED, on_close)
    ...
    def on_city_ai_click(self):
        #print(self.check_city_ai.is_pressed())
