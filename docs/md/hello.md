...
最后结果是毫无收获,也是挺尴尬.从风头之前,做到风头过去,方案还是没有确定.加上有几个职场智多星,搅得乌烟瘴气.就有点伤了.

学到一种开发方式,叫做点菜式.所有菜先点一遍,包括但不限于鲁川粤苏闽浙湘徽,并让几个手下密切关注烹饪节目,发现市场涌现的新菜,随时补充添加,对于做好的菜,随时更新迭代. 至于好还是不好,经历过的人都抑郁了.

几年过下来,团队应该把游戏开发中可能发生的错误,都错了一遍了吧.这时候,机智如我,发现了一线生机,只要避开这些坑,应该就是一条光明大道了.硬要说的话,这就是我的全部收获了.
...
- 武将: 城内武将一览,做一些立即指令,登庸,下野,致仕,训斥,训诫,惩戒,赏赐,巡查,探索,搜索
